# Matriz de rastreabilidade da versão v0.3.97
...
- versão candidata: `v0.3.97`;
- esquema de sessão: 33;
- formato de cópia de segurança: 3;
- alteração nominal da `v0.3.97`: o tipo interno `PrismState` passou a
  `CoerIAState`, sem alterar o esquema persistido, os artefactos, o fluxo ou as
  interfaces públicas;
